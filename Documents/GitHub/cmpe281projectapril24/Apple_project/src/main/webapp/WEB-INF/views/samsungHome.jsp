    ...
    <div id="myCarousel" class="carousel slide">
      <div class="carousel-inner">
        <div class="item active">
          <img src="resources/js/slide-01.jpg" alt="">
          <div class="container">
...
Nullam id dolor id nibh ultricies vehicula ut id elit.</p>
        ...
        <div class="item">
          <img src="resources/js/slide-02.jpg" alt="">
          <div class="container">
            <div class="carousel-caption">
...
Nullam id dolor id nibh ultricies vehicula ut id elit.</p>
        ...
        <div class="item">
          <img src="resources/js/slide-03.jpg" alt="">
          <div class="container">
            <div class="carousel-caption">
...
Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh,
 ut fermentum massa justo sit amet risus.</p>
      ...
      <div class="featurette">
        <img class="featurette-image pull-right" src="resources/js/browser-icon-chrome.png">
...
tellus ac cursus commodo.</p>
      ...
      <div class="featurette">
        <img class="featurette-image pull-left" src="resources/js/browser-icon-firefox.png">
...
tellus ac cursus commodo.</p>
      ...
      <div class="featurette">
        <img class="featurette-image pull-right" src="resources/js/browser-icon-safari.png">
